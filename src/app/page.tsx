    ...
    <>
      ...
      <div className="min-h-screen flex flex-col items-center justify-center p-4 overflow-hidden relative" style={{ background: '#121212' }}>
        ...
        <button
          ...
          className="fixed top-1 md:bottom-8 md:top-auto right-8 px-6 py-3 rounded-full font-medium transition-all duration-300 backdrop-blur-sm shadow-lg hover:scale-105 active:scale-95 z-20"
          style={{ 
